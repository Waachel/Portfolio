...
namespace Azul
{
	...
	StringThis::StringThis(Skel::Name status)
	{
		switch(status)
		{
		case Skel::Name::ChickenBot1:
			strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(Skel::ChickenBot1));
			break;

		case Skel::Name::ChickenBot2:
			strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(Skel::ChickenBot2));
			break;

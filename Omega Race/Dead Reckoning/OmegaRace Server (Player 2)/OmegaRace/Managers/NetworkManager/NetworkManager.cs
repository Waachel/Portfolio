...
namespace AzulNetworkBase
{
    public class NetworkManager
    {
        ...
        public NetworkManager(int serverPort)
        {
            ...
            Console.WriteLine("Packet Loss Setting: ", config.SimulatedLoss);
            config.SimulatedMinimumLatency = 0.1f;
            Console.WriteLine("Minimum Latency Setting: ", config.SimulatedMinimumLatency);
            config.SimulatedRandomLatency = 0.01f;
            Console.WriteLine("Random Latency Setting: ", config.SimulatedRandomLatency);

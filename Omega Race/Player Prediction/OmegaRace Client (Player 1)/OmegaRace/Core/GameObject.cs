...
namespace OmegaRace
{
    ...
    public class GameObject : Visitor
    {
        ...
        //predict postion of game object
        protected PlayerPredictionControl objPosPrediction;
        public Vec2 lastPos;
        ...
        public GameObject(GAMEOBJECT_TYPE _type, Azul.Rect textureRect, Azul.Rect screenRect, Azul.Texture text, Azul.Color c)
        {
            ...
            {
                objPosPrediction = new PlayerPredictionControl();
        ...
        public virtual void Update()
        {
            ...
            //predict new position of object
            if (type == GAMEOBJECT_TYPE.SHIP || type == GAMEOBJECT_TYPE.MISSILE)
            {
                objPosPrediction.PredictPos(this);
            }
        }

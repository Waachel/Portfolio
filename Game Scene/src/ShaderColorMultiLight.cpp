...
ShaderColorMultiLight::ShaderColorMultiLight(ID3D11Device* dev)
	: ShaderBase(dev, L"../Assets/Shaders/ColorMultiLight.hlsl")
{
...
ShaderColorMultiLight::~ShaderColorMultiLight()
{
...
void ShaderColorMultiLight::SendCamMatrices(const Matrix& view, const Matrix& proj)
{
...
void ShaderColorMultiLight::SetDirectionalLightParameters(const Vect& dir, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorMultiLight::SetPointLightParameters(int index, const Vect& pos, float r, const Vect& att, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorMultiLight::SetSpotLightParameters(int index, const Vect& pos, float r, const Vect& att, const Vect& dir, float spotExp, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorMultiLight::SendLightParameters(const Vect& eyepos)
{
	Data_LightParams dl;
...
void ShaderColorMultiLight::SendWorldAndMaterial(const Matrix& world, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorMultiLight::SetToContext(ID3D11DeviceContext* devcon)
{

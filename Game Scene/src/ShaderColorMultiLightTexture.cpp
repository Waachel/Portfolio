...
ShaderColorMultiLightTexture::ShaderColorMultiLightTexture(ID3D11Device* dev)
	: ShaderBase(dev, L"../Assets/Shaders/ColorMultiLightTexture.hlsl")
{
	...
	FogData.FogStart = INFINITY;
	FogData.FogRange = INFINITY;
	FogData.FogColor = Colors::White;
}

ShaderColorMultiLightTexture::~ShaderColorMultiLightTexture()
{
...
void ShaderColorMultiLightTexture::SendCamMatrices(const Matrix& view, const Matrix& proj)
{
...
void ShaderColorMultiLightTexture::SendWorld(const Matrix& world)
{
	WorldData wc;
	wc.World = world;
...
void ShaderColorMultiLightTexture::SetDirectionalLightParameters(const Vect& dir, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorMultiLightTexture::SetPointLightParameters(int index, const Vect& pos, float r, const Vect& att, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorMultiLightTexture::SetSpotLightParameters(int index, const Vect& pos, float r, const Vect& att, const Vect& dir, float spotExp, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorMultiLightTexture::SetFogParameters(const float& fs, const float& fr, const Vect& fc)
{
	FogData.FogStart = fs;
	FogData.FogRange = fr;
	FogData.FogColor = fc;
...
void ShaderColorMultiLightTexture::SendLightParameters(const Vect& eyepos)
{
	Data_LightParams dl;
...
void ShaderColorMultiLightTexture::SendWorldAndMaterial(const Matrix& world, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorMultiLightTexture::SetToContext(ID3D11DeviceContext* devcon)
{

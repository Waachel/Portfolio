...
void meshData::Serialize(meshData_proto &out) const
{
	...
	out.set_boundingsphereradius(this->boundingSphereRadius);
	out.set_boundingspherecenter1(this->boundingSphereCenter[0]);
	out.set_boundingspherecenter2(this->boundingSphereCenter[1]);
	out.set_boundingspherecenter3(this->boundingSphereCenter[2]);
...
void meshData::Deserialize(const meshData_proto &in)
{
	...
	this->boundingSphereRadius = in.boundingsphereradius();
	this->boundingSphereCenter[0] = in.boundingspherecenter1();
	this->boundingSphereCenter[1] = in.boundingspherecenter2();
	this->boundingSphereCenter[2] = in.boundingspherecenter3();

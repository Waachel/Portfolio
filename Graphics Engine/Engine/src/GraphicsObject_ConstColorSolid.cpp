...
// ---------------------------------------------
GraphicsObject_ConstColorSolid::GraphicsObject_ConstColorSolid(Mesh *mesh,
...
GraphicsObject_ConstColorSolid::~GraphicsObject_ConstColorSolid()
{
	delete poLightColor;

}

void GraphicsObject_ConstColorSolid::SetState()
{
...
void GraphicsObject_ConstColorSolid::SetDataGPU()
{
...
void GraphicsObject_ConstColorSolid::Draw()
{
	pMesh->RenderIndexBuffer();
}

void GraphicsObject_ConstColorSolid::RestoreState()
{

...
// ---------------------------------------------
GraphicsObject_Solid::GraphicsObject_Solid(Mesh *_pMesh, ShaderObject *_pShaderObj)
...
void GraphicsObject_Solid::SetState()
{
...
void GraphicsObject_Solid::SetDataGPU()
{
...
void GraphicsObject_Solid::Draw()
{
	pMesh->RenderIndexBuffer();
}

void GraphicsObject_Solid::RestoreState()
{
	// Need to do this properly...
	D3D11_RASTERIZER_DESC rasterizerDesc;
	memset(&rasterizerDesc, 0, sizeof(D3D11_RASTERIZER_DESC));
